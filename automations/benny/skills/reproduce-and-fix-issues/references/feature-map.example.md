...
Copy this file outside `.github/automations/benny/`, for example to `.github/benny/feature-map.md`, and set `control.feature_map_path` to the copy. Pack refreshes must not overwrite it.

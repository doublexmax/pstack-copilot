...
- `model`: your configured how-explorer model (default `grok-4.5 / high`)
...
After the explanation is complete, spawn one architectural critic per model in your configured how-critics list (defaults `gemini-3.1-pro-preview / high`, `gpt-5.6-sol / xhigh`, `grok-4.5 / high`, `claude-opus-5 / xhigh`), all in a single message.

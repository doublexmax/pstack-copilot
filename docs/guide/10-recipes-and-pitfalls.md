...
![She tastes a finished dish while robots cook from a recipe box, with pinned command cards above the counter.](./images/recipes.jpg)
...
- **A vague finish condition.** "make it better" gives autopilot nothing to check. Give a command or artifact that can pass or fail.
